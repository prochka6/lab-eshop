...
public interface IBasketItemDao extends IBaseDao<BasketItem, Long> {
	 ...
	 * 
	 * @param productItem
	 *            product which is connected with basketitem
	 * @param basket
	 *            basket in which is product contaion
	 * @return concrete basket item which is in concrete basket and is connected
	 *         with concrete product
	 */
