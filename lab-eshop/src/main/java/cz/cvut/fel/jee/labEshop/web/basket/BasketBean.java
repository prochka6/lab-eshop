...
/**
 * This bean is controller to basket, it provide add to basket, create basket and modify basket functions
 * @author Tom
 *
 */
@Named("basketBean")
...
public class BasketBean implements Serializable{
   ...
   @Inject
	...
	/**
	 * This function call business methods to add item to basket. Item id is taken from FacesContext.
	 */
