 ...
 * @author Tom
 *
 * @param <T> entity which will be manager work
 */
...
public class BaseManager <T> implements Serializable{
	...
	/**
	 * This method add item to collection, if collection is null then new collection is create
	 * @param collection to which will be added item
	...
	/**
	 * This method remove item from collection, if collection is null then empty collection is returned.
	 * @param collection from which will be removed item
	 * @param itemToRemove item to remove from collection
